...
<!--  v.nameField.$errors - содержит массив ошибок-->
  <form @submit.prevent="submitForm">
    <add-input
      ...
      v-model:value="validation.nameField.$model"
      :error="validation.nameField.$errors"/>
    ...
    <add-input
      ...
      v-model:value="validation.luckyField.$model"
      :error="validation.luckyField.$errors"/>
    ...
    <add-input
      ...
      v-model:value="validation.frontendField.$model"
      :error="validation.frontendField.$errors"/>
